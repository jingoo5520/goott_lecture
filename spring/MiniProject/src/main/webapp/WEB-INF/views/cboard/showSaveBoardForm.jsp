	...
	<div class="container">
		...
		<form action="saveBoard" method="post">
			...
			<div class="input-group mb-3">
				...
				<input type="text" class="form-control" placeholder="작성자를 입력하세요..." name="writer" value="${sessionScope.loginMember.userId}" readonly>
			</div>
			...
			<button type="reset" class="btn btn-warning mb-3" onclick="cancelBoard();">취소</button>
		</form>
	</div>
